...
def prepare_parser():
  ...
  ### Selective Focusing Learning stuff ###
  parser.add_argument(
...
def get_data_loaders(dataset, data_root=None, augment=False, batch_size=64, 
  ...
  scores_filepath = '{}_{}_scores_{}_{}_{}.pkl' \
    .format(dataset, image_size, embedding, density_measure, 100.0)
  labels_filepath = '{}_{}_labels_{}_{}_{}.pkl'\
    .format(dataset, image_size, embedding, density_measure, 100.0)
  indices_filepath = '{}_{}_indices_{}_{}_{}.pkl' \
    .format(dataset, image_size, embedding, density_measure, retention_ratio)


  scores_filepath = os.path.join(indices_folder, scores_filepath)
  labels_filepath = os.path.join(indices_folder, labels_filepath)
  indices_filepath = os.path.join(indices_folder, indices_filepath)

  train_set, score_stack, labels_stack = select_instances(dataset=train_set,
                               retention_ratio=retention_ratio,
                               embedding=embedding,
                               density_measure=density_measure,
                               scores_filepath=scores_filepath,
  ...
  return loaders, train_set, score_stack, labels_stack
